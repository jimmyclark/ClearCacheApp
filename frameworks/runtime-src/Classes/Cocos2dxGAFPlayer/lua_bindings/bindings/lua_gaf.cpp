...
//        cobj->setAnimationStartedNextLoopDelegate(arg0);
        ...
        cobj->setAnimationStartedNextLoopDelegate([=](gaf::GAFObject* obj){
            LuaEngine::getInstance()->getLuaStack()->pushObject(obj, "gaf.GAFObject");
...
//        cobj->setFramePlayedDelegate(arg0);
        ...
        LUA_FUNCTION handle = toluafix_ref_function(tolua_S,2,0);
        cobj->setFramePlayedDelegate([=](gaf::GAFObject* obj,uint32_t frame){
            auto luaStack=LuaEngine::getInstance()->getLuaStack();
            luaStack->pushObject(obj, "gaf.GAFObject");
            luaStack->pushInt(frame);
            luaStack->executeFunctionByHandler(handle,2);
        });
