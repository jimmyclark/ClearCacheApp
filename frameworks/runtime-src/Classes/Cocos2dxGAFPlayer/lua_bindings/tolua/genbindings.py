...
def main():
    ...
    gaf_root = os.path.join(os.path.dirname(__file__), "..", "..")
    ...
    try:
        ...
        # tolua_root = os.path.dirname(__file__)
        tolua_root = '%s/external/Cocos2dxGAFPlayer-release-gaf-5/lua_bindings/tolua' % project_root
        output_dir = '%s/../bindings' % tolua_root

        cmd_args = {'gaf.ini' : ('gaf', 'lua_gaf'), \
                    }
        target = 'lua'
